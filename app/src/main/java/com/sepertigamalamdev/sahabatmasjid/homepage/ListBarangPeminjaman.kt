...
@Composable
fun BorrowItemListScreen(navController: NavController) {
    Scaffold(
...
@Composable
fun BorrowItemListScreenPreview(navController: NavHostController = rememberNavController()) {
    BorrowItemListScreen(navController = navController)
}